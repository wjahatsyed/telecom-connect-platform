...
class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiErrorResponse> handleNotFound(SubscriptionNotFoundException exception) {
    ...
    ResponseEntity<ApiErrorResponse> handleInvalidState(InvalidSubscriptionStateException exception) {
